          ...
          div.control
            div.select.is-fullwidth
              select(name="form.reward" v-model="form.reward" v-validate="validations.reward" data-vv-as="Distintivo Solicitado" v-bind:class="{'is-danger': errors.has('form.reward')}")
                ...
                option(value="Bons Serviços 25 anos") Bons Serviços 25 anos
                option(value="Bons Serviços 30 anos") Bons Serviços 30 anos
                option(value="Bons Serviços 35 anos") Bons Serviços 35 anos
                option(value="Bons Serviços 40 anos") Bons Serviços 40 anos
                option(value="Bons Serviços 45 anos") Bons Serviços 45 anos
                ...
                option(value="Cruz de Valor Caio Viana Martins") Cruz de Valor Caio Viana Martins
                option(value="Cruz de Valor Maria Perola Sodre") Cruz de Valor Maria Perola Sodre
                option(value="Escotismo - Educação para Vida") Escotismo - Educação para a Vida
                option(value="Tucano de Prata") Tucano de Prata
                option(value="Lobo Guará") Lobo Guará de Prata
                option(value="Tiradentes") Tiradentes
                option(value="Tapir de Prata") Tapir de Prata
                option(value="Trofeu Baobá: 15 anos de fundação GE") Trofeu Baobá: 15 anos de fundação GE
...
<script>
  ...
  export default {
    ...
    methods: {
      submitForm () {
        this.$ga.trackEvent('Requests Form', 'Submit', 'Rewards')
        this.submitted = true
    ...
    head: {
      ...
      meta: () => {
        return getSeoMeta({
          title: 'Formulário de Condecorações e Recompensas - Escoteiros de Minas',
